...
export interface Conversation {
  ...
  updated_at: string;
  contact?: Contact;
  // ---- Multi-channel / groups (Evolution / Baileys) ----
  /** Which connection (whatsapp_instances) this thread sends/receives on. */
  instance_id?: string | null;
  /** True for a WhatsApp group thread (no single contact). */
  is_group?: boolean;
  /** `<id>@g.us` for groups. */
...
export interface Message {
  ...
  /** Group sender JID (group threads only). */
  group_participant_jid?: string | null;
  /** Group sender push name, shown above incoming group bubbles. */
